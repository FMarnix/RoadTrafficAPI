...
urlpatterns = [
    ...
    path('api/observations/bulk/', BulkObservationView.as_view(), name='bulk-observation'),
    path('api/observations/<str:license_plate>/', CarObservationsView.as_view(), name='car-observations'),
